# Arduino_SBUS
Enables a Frysky receiver SBUS connection to control an Arduino, to give you full 16 channels to activate extra cool devices on your radio controlled model, such as Lights, PPM servos, sensors, parachute,etc....the skys the limit :-)
